...
Локальный десктопный дневник разработчика. Трекаешь ИТ-проекты, ведёшь записи по дням, смотришь статистику потраченного времени. Данные хранятся локально в SQLite — без облака и авторизации.
